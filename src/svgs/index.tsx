...
export const Home = ({fill}: any) => {
    return (
        <svg width="35" height="35" fill={fill} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8h5Z"></path>
</svg>
    )
}
export const Search = ({fill}: any) => {
    return (
        <svg width="30" height="30" fill="none" stroke={fill} stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const Menu = ({fill}: any) => {
    return (
        <svg width="28" height="28" fill="none" stroke={fill} stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
